...
export default function App() {
  ...
  useEffect(() => {
    ...
    return () => { window.removeEventListener('keydown', handleKeyDown); window.removeEventListener('mouseup', handleMouseUp); };
        ...
        try {
          ...
          Object.entries(results).forEach(([key, res]) => {
            ...
            formulaFolders[folderKey]?.file(
              `${fileBase}.out`,
              formatSingleFormulaOutput(inputPayload as InputData, key, res)
            );
          });
